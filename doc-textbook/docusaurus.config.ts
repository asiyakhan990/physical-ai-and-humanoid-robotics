...
const config: Config = {
  ...
  plugins: [
    [
      ...
      {
        hashed: true,
        // 🛑 FIX IS HERE: Change 'en' (string) to ['en'] (array)
        language: ['en'], 
        indexDocs: true,
        indexBlog: true,
        indexPages: false,
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright � 2025 Physical AI & Humanoid Robotics Textbook, Built with ❤️ by Asiya khan.`,
    },
    prism: {
